...
for group_no = 1 : length(groups)
    ...
    writecell(BA_results_table, [savepath, '.csv']);
    ...
    savepath = [up.paths.tables_save_folder, save_name];
    writecell(stats_results_table, [savepath, '.csv'])
    ...
    savepath = [up.paths.tables_save_folder, save_name];
    writecell(comb_results_table, [savepath, '.csv'])
...
savepath = [up.paths.tables_save_folder, save_name];
writecell(table_data, [savepath, '.csv'])
