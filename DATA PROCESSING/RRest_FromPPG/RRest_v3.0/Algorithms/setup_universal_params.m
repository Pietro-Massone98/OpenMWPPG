...
up.paths.root_folder = 'C:\Users\pietr\OneDrive - Politecnico di Milano\PhD_Projects_2024\PPG_Nicola\PyRRat\rrest_data\';
...
up.al.options.extract_resp_sig = {'ppg_feat', 'ppg_filt'}; %modificata da me
% ------------------------------------------------------
...
up.al.options.FMe = {'am', 'fm', 'bw', 'bwm', 'pk', 'on', 'qrsW', 'qrsA'};       % Possible methods: 'pulW', 'am', 'fm', 'bw', 'pk', 'on', 'bwm', 'qrsW', 'qrsA', 'pca', 'qrS', 'rsS', 'Rang'
% ------------------------------------------------------
...
data_new_path = fullfile(up.paths.data_load_folder, [up.paths.data_load_filename '.mat']);

% TUO LAYOUT: root_folder\period\period_data.mat
data_orig_path  = fullfile(up.paths.root_folder, period_orig, [up.paths.data_load_filename '.mat']);
data_orig_path2 = fullfile(up.paths.root_folder, period_orig, [up.paths.data_load_filename2 '.mat']);
...
% Filter characteristics: Eliminate VLFs (below resp freqs): For 4bpm cutoff
up.paramSet.elim_vlf.Fpass = 0.07;  % in Hz
up.paramSet.elim_vlf.Fstop = 0.01;   % in Hz     (0.157 and 0.02 provide a - 3dB cutoff of 0.0665 Hz)
up.paramSet.elim_vlf.Dpass = 0.05;
up.paramSet.elim_vlf.Dstop = 0.01;
